...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-595-erd-s-problem-595-75882921-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-595"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-595-erd-s-problem-595-75882921-v1",
      "problem_contract_sha256": "e77353b3932c08db70132cbf2fe158aea94b8a412a13e406832bb9c0c81773ca",
      "problem_id": "problem:um-ep-595-erd-s-problem-595-75882921",
      "route_id": "route:um-ep-595-erd-s-problem-595-75882921-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-595-erd-s-problem-595-75882921-source-fidelity-01",
      "graph_id": "graph:um-ep-595-erd-s-problem-595-75882921-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-595-erd-s-problem-595-75882921-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-595-erd-s-problem-595-75882921-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there an infinite graph $G$ which contains no $K_4$ and is not the union of countably many triangle-free graphs?"
          },
          "statement_sha256": "117e7416381d4da88ae276893ddde5b000a470665f934469865568ba21a54c4a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-595-erd-s-problem-595-75882921-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-595-erd-s-problem-595-75882921-root",
      "route_id": "route:um-ep-595-erd-s-problem-595-75882921-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-595-edeebb03feb5",
        "url": "https://www.unsolvedmath.com/problems/EP-595"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
